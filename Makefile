...
# ---- Phony targets ----
.PHONY: all run clean test e2e help
...
# ---- Build & run E2E tests ----
# วิธี 1: ใช้ binary C (tests/test_e2e) เพื่อรันทดสอบ
e2e-bin: $(E2E_BIN) $(BIN)
	./$(E2E_BIN)
...
# วิธี 2: ใช้สคริปต์ input+grep (ตรงกับ run_e2e_test ในโปรแกรมหลัก)
# พิมพ์: make e2e
e2e: $(BIN)
...
help:
	...
	@echo "  make e2e       # run E2E via input script/grep"
